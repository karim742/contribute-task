    ...
    <header className="bg-[#f7f7f7] shadow-headerShadow">
      ...
      <div className="mx-auto max-w-screen-2xl p-2">
        ...
        <div className="flex items-center justify-between">
          ...
          {/* nav Item  */}
          <nav
            className={`absolute top-28 flex h-screen flex-col items-center gap-5 md:static md:h-auto md:flex-row md:gap-10 ${
              showDrawer ? "left-0" : "-left-40"
            } z-50 bg-[#f7f7f7] transition-all md:bg-none`}
          >
            <a href="#" className="px-5 py-1 text-xl font-medium md:p-0">
              Home
            </a>
            <a href="#" className="px-5 py-1 text-xl font-medium md:p-0">
              Blog
